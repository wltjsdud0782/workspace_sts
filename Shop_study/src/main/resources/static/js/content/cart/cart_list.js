...
function updateCartCnt(selectThis, cartCode, itemPrice){
    ...
    if(result){
        ...
        const a = selectThis.parentElement.parentElement.parentElement.nextElementSibling;
        let resultprice = itemPrice * upCnt;
        ...
        .then((data) => {//data -> controller에서 리턴되는 데이터!
            a.replaceChildren(a.textContent ='￦' + resultprice.toLocaleString());
            setAllPrice();
